  ...
  return (
    <section className="pt-14 pb-[1.75rem] md:pt-[5.5.rem] md:pb-11">
      ...
      <div className="flex justify-center">
        <div
          className="max-md:w-screen max-md:cursor-grab max-md:grid max-md:grid-cols-[1fr] max-md:overflow-x-auto max-md:overflow-y-hidden max-md:no-scrollbar"
          ref={refPreconditions}
        >
          <div className="place-items-center grid grid-cols-[auto_56px] md:grid-cols-[auto]">
            <div className="max-md:translate-x-[1.75rem] rounded-lg p-0.5 border border-border-gray bg-bg-light-gray mb-6 grid grid-cols-[repeat(3,min-content)] max-w-[420px]">
